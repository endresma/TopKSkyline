 ...
 */
public abstract class AbstractEquivalenceClass implements
        IEquivalenceClass {
     ...
     */
    protected AbstractEquivalenceClass(FlatLevelCombination lvl) {
        this.lvl = lvl;
//        initList();
    ...
    /**
     * Initialize list data structure for the elements in this equivalence class.
     */
