 ...
 * @version 2007-06-18
 */
public class FlatLCBNL implements Iterator {
    /**
     ...
     */
    public FlatLCBNL(Iterator input, IPreference preference) {
...
//	   System.out.println("Window Size: " + candidates.size());
        ...
        try {
            ...
            for (int i = 0; i < candidates.size(); i++) {
                ...
                FlatLevelCombination flc = (FlatLevelCombination)candidates.get(i);
                result = flc.compare(cand);

//                result = preference.compare(candidates.get(i), cand, null);
                nrOfcomparison++;
