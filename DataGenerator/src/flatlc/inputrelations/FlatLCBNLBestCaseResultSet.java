...
/**
 * <p>
 * This class represents a result set for a best case performance of BNL: the
 * first tuple returned will have a level of zero and so be a perfect match. All
 * other tuples will have higher level values and so be worse than the first
 * tuple.
 * 
