...
/**
 * <p>
 * This class represents a result set created of random numbers. As the seeds
 ...
 * @see RandomResultSet
 */
public class FlatLCRandomResultSet extends FlatLCResultSetA {
    /**
     * default maximum for column (=level) values
     */
     ...
     */
    public FlatLCRandomResultSet(int cols, int rows) {
     ...
     */
    public FlatLCRandomResultSet(int cols, int rows, int offset) {
     ...
     * @param offset  number of rows thrown away before returning the first row
     */
    public FlatLCRandomResultSet(int cols, int rows, int maximum, int offset) {
        this.rows = rows;
        this.offset = offset;
     ...
     */
    public FlatLCRandomResultSet(int rows, int[] maxValues) {
     ...
     */
    public FlatLCRandomResultSet(int rows, int[] maxValues, boolean inMem) {
        this.rows = rows;
     ...
     * @param offset    number of rows thrown away before returning the first row
     */
    public FlatLCRandomResultSet(int rows, int[] maxValues, int offset) {
     ...
     */
    public FlatLCRandomResultSet(int rows, int[] maxValues, int offset, int seed) {
        this.rows = rows;
        this.maxValues = maxValues;
        this.offset = offset;
        this.seed = seed;
